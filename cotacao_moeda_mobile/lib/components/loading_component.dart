    ...
    return Stack(      
      ...
      children: [
        Center(child: AnimatedBuilder(
            ...
            child: ImageComponent(uri: "images/d1d10576-2038-4479-9879-2b631983fb0c.png", height: heightLeft, width: widthLeft))),
        Center(child: AnimatedBuilder(
          animation: animationController,
          builder: (_, child) {
            return Transform.rotate(
          ...
          child: ImageComponent(uri: "images/bdc30dca-7ae0-4510-b971-c7dac3aa04f3.png",height: heightRight, width: widthRight))),
      ],
    );
  }
}
