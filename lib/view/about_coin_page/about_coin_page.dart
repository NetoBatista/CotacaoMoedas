...
class _AboutCoinPageState extends State<AboutCoinPage> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset("assets/videos/2fd73472-fcff-481e-b647-835adf01ef1d.mp4");
    ...
    return SingleChildScrollViewComponent(
      child: ContainerComponent(
        ...
        child: ColumnComponent(children: [
          CenterComponent(child: ImageComponent(uri: widget.coinModel.image, heroTag: widget.coinModel.name)),
